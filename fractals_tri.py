...
def fractal(pos, length, d_length, angle, d_angle, iteration=0, max_iter=12):
...
while running:
  ...
  fractal((500, 500), 150, 1.5, math.radians(0), math.radians(angle))
  fractal((500, 500), 150, 1.5, math.radians(120), math.radians(angle))
  fractal((500, 500), 150, 1.5, math.radians(240), math.radians(angle))
